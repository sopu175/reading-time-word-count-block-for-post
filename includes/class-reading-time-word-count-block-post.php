...
class Reading_Time_Word_Count_Block_Post
{
    ...
    {
        if (defined('Reading_Time_Word_Count_Block_Post_VERSION')) {
            $this->version = Reading_Time_Word_Count_Block_Post_VERSION;
        } else {
            $this->version = '1.0.0';
        }
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_rtwc_save_settings', $plugin_admin, 'save_settings');
    }
